    ...
    <div tabindex="-1" ref="gj-image-viewer__wrapper" class="gj-image-viewer__wrapper" :style="{ 'z-index': viewerZIndex }">
      ...
      <div class="gj-image-viewer__btn gj-image-viewer__actions">
        <div class="gj-image-viewer__actions__inner">
          ...
          <!--左旋-->
          <i class="Gildata-anticlockwise" @click="handleActions('anticlocelise')"></i>
          <!--右旋-->
          <i class="Gildata-clockwise" @click="handleActions('clocelise')"></i>
          <!--放大-->
          <i class="Gildata-enlarged" @click="handleActions('zoomIn')"></i>
          <i class="Gildata-narrow" @click="handleActions('zoomOut')"></i>
        </div>
      </div>
      <!-- CANVAS -->
...
<script>
import { on, off } from 'GildataDesign/src/utils/dom';
import { rafThrottle, isFirefox } from 'GildataDesign/src/utils/util';
import { PopupManager } from 'GildataDesign/src/utils/popup';
