<template>
  <div>
    <p class="tip">
      树形虚拟滚动渲染<span class="orange">（最大可以支撑 1w 列、5w 行）</span>，具体兼容请查看 <a class="link" href="https://github.com/x-extends/gj-table-plugin-virtual-tree" target="_blank">gj-table-plugin-virtual-tree</a> 插件的 API<br>
