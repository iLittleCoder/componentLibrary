<template>
  <div>
    ...
    <gj-table
      ...
      :scroll-y="{gt: 20}"
      :data="tableData">
      <gj-column type="seq" width="200" tree-node></gj-column>
...
export default {
  data () {
    return {
      tableData: [
        { id: 110000, parentId: null, name: 'gj-table test abc1', type: 'mp3', size: 1024, date: '2020-08-01' },
        { id: 111000, parentId: 110000, name: 'gj-table test abc2', type: 'html', size: 600, date: '2021-04-01' },
        { id: 111100, parentId: 111000, name: 'gj-table test abc3', type: 'html', size: 600, date: '2021-04-01' },
        { id: 111110, parentId: 111100, name: 'gj-table test abc4', type: 'html', size: 600, date: '2021-04-01' },
        { id: 111111, parentId: 111110, name: 'gj-table test abc5', type: 'html', size: 600, date: '2021-04-01' },
        { id: 111112, parentId: 111110, name: 'gj-table test abc6', type: 'html', size: 600, date: '2021-04-01' },
        ...
        { id: 121100, parentId: 121000, name: 'gj-table test abc9', type: 'html', size: 600, date: '2021-04-01' },
        { id: 121200, parentId: 121000, name: 'gj-table test abc10', type: 'avi', size: null, date: '2021-04-01' },
        { id: 121300, parentId: 121000, name: 'gj-table test abc11', type: 'txt', size: 25, date: '2021-10-01' },
        ...
        { id: 163600, parentId: 164000, name: 'gj-table test abc29', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 164300, parentId: 164000, name: 'gj-table test abc33', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 164900, parentId: 164000, name: 'gj-table test abc40', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 230000, parentId: null, name: 'gj-table test abc67', type: 'avi', size: 224, date: '2020-10-01' },
        ...
        { id: 254200, parentId: 254000, name: 'gj-table test abc75', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 254323, parentId: 254320, name: 'gj-table test abc81', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 254340, parentId: 254300, name: 'gj-table test abc87', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 254370, parentId: 254300, name: 'gj-table test abc90', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 254600, parentId: 254000, name: 'gj-table test abc93', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 262100, parentId: 262000, name: 'gj-table test abc103', type: 'avi', size: 224, date: '2020-10-01' },
        ...
        { id: 264000, parentId: 260000, name: 'gj-table test abc107', type: 'avi', size: 224, date: '2020-10-01' },
        ...
        { id: 290000, parentId: null, name: 'gj-table test abc110', type: 'avi', size: 224, date: '2020-10-01' },
        ...
        { id: 325000, parentId: 320000, name: 'gj-table test abc118', type: 'avi', size: 224, date: '2020-10-01' },
        ...
        { id: 329100, parentId: 329000, name: 'gj-table test abc123', type: 'avi', size: 224, date: '2020-10-01' },
        ...
        { id: 329810, parentId: 329800, name: 'gj-table test abc130', type: 'avi', size: 224, date: '2020-10-01' },
