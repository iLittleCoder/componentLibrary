<template>
  <div>
    ...
    <p>
      <gj-table-tooltip content="我是提示内容">
        <a class="link">文字提示</a>
      </gj-table-tooltip>
    </p>

    <p>
      <gj-table-tooltip content="除了点击之外不会自动消息" trigger="click">
        <vxe-button>点击触发</vxe-button>
      </gj-table-tooltip>
      <gj-table-tooltip content="hover 提示内容">
        <vxe-button>Hover 触发</vxe-button>
      </gj-table-tooltip>
      <gj-table-tooltip content="鼠标可以进入到 tooltip 中" enterable>
        <vxe-button>设置 Enterable</vxe-button>
      </gj-table-tooltip>
    </p>

    <p>
      <gj-table-tooltip v-model="value1" content="自定义提示内容" trigger="manual">
        <vxe-button @mouseenter="value1 = true" @mouseleave="value1 = false">手动模式</vxe-button>
      </gj-table-tooltip>
    </p>

    <p>
      <gj-table-tooltip ref="myTip"></gj-table-tooltip>
