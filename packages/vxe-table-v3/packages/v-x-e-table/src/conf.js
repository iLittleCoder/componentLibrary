...
export default {
  ...
  icon: {
    // table
    TABLE_SORT_ASC: 'Gildata-s-uparrow',
    TABLE_SORT_DESC: 'Gildata-s-downarrow',
    TABLE_FILTER_NONE: 'Gildata-screen1',
    TABLE_FILTER_MATCH: 'Gildata-screen1',
    TABLE_EDIT: iconPrefix + 'edit-outline',
    TABLE_HELP: 'el-icon-question',
    TABLE_TREE_LOADED: iconPrefix + 'refresh roll',
    TABLE_TREE_OPEN: 'Gildata-fold',
    TABLE_TREE_CLOSE: 'Gildata-unfurled',
