      ...
      template: `
        <el-dropdown ref="dropdown">
          ...
          <el-dropdown-menu slot="dropdown" class="dropdown-test-creat">
            ...
            <el-dropdown-item>比亚迪</el-dropdown-item>
            <el-dropdown-item>阿里巴巴</el-dropdown-item>
      ...
      template: `
        <el-dropdown ref="dropdown">
          ...
          <el-dropdown-menu slot="dropdown">
            ...
            <el-dropdown-item command="b">比亚迪</el-dropdown-item>
            <el-dropdown-item ref="commandC" :command="myCommandObject">阿里巴巴</el-dropdown-item>
    ...
    vm = createVue({
      template: `
        <el-dropdown trigger="click" ref="dropdown">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>黄金糕</el-dropdown-item>
            <el-dropdown-item @click.native="handleClick">比亚迪</el-dropdown-item>
            <el-dropdown-item>阿里巴巴</el-dropdown-item>
            <el-dropdown-item>双皮奶</el-dropdown-item>
            <el-dropdown-item>蚵仔煎</el-dropdown-item>
          </el-dropdown-menu>
      ...
      template: `
        <el-dropdown ref="dropdown" :hide-on-click="false">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item command="a">黄金糕</el-dropdown-item>
            <el-dropdown-item command="b">比亚迪</el-dropdown-item>
            <el-dropdown-item ref="commandC" command="c">阿里巴巴</el-dropdown-item>
            <el-dropdown-item command="d">双皮奶</el-dropdown-item>
            <el-dropdown-item command="e">蚵仔煎</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      ...
      template: `
        <el-dropdown ref="dropdown">
          ...
          <el-dropdown-menu slot="dropdown" class="dropdown-test-creat">
            <el-dropdown-item command="a">黄金糕</el-dropdown-item>
            <el-dropdown-item command="b">比亚迪</el-dropdown-item>
            <el-dropdown-item command="c">阿里巴巴</el-dropdown-item>
            <el-dropdown-item command="d">双皮奶</el-dropdown-item>
            <el-dropdown-item command="e">蚵仔煎</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
