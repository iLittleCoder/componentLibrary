  ...
  <jy-table
    ...
    <jy-column
      ...
      <template slot-scope="scope">
        <jy-button @click="handleClick(scope.row)" type="text" size="small">查看</jy-button>
        <jy-button type="text" size="small">编辑</jy-button>
      </template>
    </jy-column>
  </jy-table>
</template>
...
<template>
  ...
  <div style="margin-top: 20px">
    <jy-button @click="setCurrent(tableData[1])">选中第二行</jy-button>
    <jy-button @click="setCurrent()">取消选择</jy-button>
  </div>
</template>
...
<template>
  ...
  <div style="margin-top: 20px">
    <jy-button @click="toggleSelection([tableData[1], tableData[2]])">切换第二、第三行的选中状态</jy-button>
    <jy-button @click="toggleSelection()">取消选择</jy-button>
  </div>
</template>
...
```html
<template>
  <jy-button @click="resetDateFilter">清除日期过滤器</jy-button>
  <jy-button @click="clearFilter">清除所有过滤器</jy-button>
  <jy-table
    ref="filterTable"
    :data="tableData"
    style="width: 100%">
    ...
    <jy-column
      ...
      <template slot-scope="scope">
        <jy-tag
          ...
          disable-transitions>{{scope.row.tag}}</jy-tag>
      </template>
    </jy-column>
  </jy-table>
</template>
...
<template>
  <jy-table
    ...
    <jy-column
      ...
      width="180">
      <template slot-scope="scope">
        <jy-popover trigger="hover" placement="top">
          <p>姓名: {{ scope.row.name }}</p>
          <p>住址: {{ scope.row.address }}</p>
          <div slot="reference" class="name-wrapper">
            <jy-tag size="medium">{{ scope.row.name }}</jy-tag>
          </div>
        </jy-popover>
      </template>
    </jy-column>
    <jy-column label="操作">
      <template slot-scope="scope">
        <jy-button
          size="mini"
          @click="handleEdit(scope.$index, scope.row)">编辑</jy-button>
        <jy-button
          size="mini"
          type="danger"
          @click="handleDelete(scope.$index, scope.row)">删除</jy-button>
      </template>
    </jy-column>
  </jy-table>
</template>
...
<template>
  <jy-table
    :data="tableData"
    style="width: 100%">
    <jy-column type="expand">
      <template slot-scope="props">
        <jy-form label-position="left" inline class="demo-table-expand">
          <jy-form-item label="商品名称">
            <span>{{ props.row.name }}</span>
          </jy-form-item>
          <jy-form-item label="所属店铺">
            <span>{{ props.row.shop }}</span>
          </jy-form-item>
          <jy-form-item label="商品 ID">
            <span>{{ props.row.id }}</span>
          </jy-form-item>
          <jy-form-item label="店铺 ID">
            <span>{{ props.row.shopId }}</span>
          </jy-form-item>
          <jy-form-item label="商品分类">
            <span>{{ props.row.category }}</span>
          </jy-form-item>
          <jy-form-item label="店铺地址">
            <span>{{ props.row.address }}</span>
          </jy-form-item>
          <jy-form-item label="商品描述">
  ...
  <jy-table
    ...
    <jy-column
      ...
      <template slot-scope="scope">
        <jy-button
          size="mini"
          @click="handleEdit(scope.$index, scope.row)">Edit</jy-button>
        <jy-button
          size="mini"
          type="danger"
          @click="handleDelete(scope.$index, scope.row)">Delete</jy-button>
      </template>
    </jy-column>
  </jy-table>
</template>
