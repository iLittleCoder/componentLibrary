...
<template>
  <div class="block">
    ...
    <jy-carousel height="150px">
      <jy-carousel-item v-for="item in 4" :key="item">
  ...
  <div class="block">
    ...
    <jy-carousel trigger="click" height="150px">
      <jy-carousel-item v-for="item in 4" :key="item">
        <h3 class="small">{{ item }}</h3>
      </jy-carousel-item>
    </jy-carousel>
...
```html
<template>
  <jy-carousel indicator-position="outside">
    <jy-carousel-item v-for="item in 4" :key="item">
      <h3>{{ item }}</h3>
    </jy-carousel-item>
  </jy-carousel>
...
```html
<template>
  <jy-carousel :interval="5000" arrow="always">
    <jy-carousel-item v-for="item in 4" :key="item">
      <h3>{{ item }}</h3>
    </jy-carousel-item>
  </jy-carousel>
...
```html
<template>
  <jy-carousel :interval="4000" type="card" height="200px">
    <jy-carousel-item v-for="item in 6" :key="item">
...
```html
<template>
  <jy-carousel height="200px" direction="vertical" :autoplay="false">
    <jy-carousel-item v-for="item in 3" :key="item">
      <h3 class="medium">{{ item }}</h3>
    </jy-carousel-item>
  </jy-carousel>
</template>
