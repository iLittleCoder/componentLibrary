...
```html
<template>
  <jy-transfer v-model="value" waring-text="选择个数不能超过5个" :max-length="5" :data="data"></jy-transfer>
</template>
...
```html
<template>
  <jy-transfer show-pagination :page-size="10" v-model="value" :data="data"></jy-transfer>
</template>
...
```html
<template>
  <jy-transfer show-pagination one-way v-model="value" :data="data"></jy-transfer>
</template>
...
<template>
  ...
  <div>
    <jy-transfer
      ...
      @change="handleChange"
      :data="data">
      <jy-button class="transfer-footer" slot="left-footer" size="mini">操作</jy-button>
      <jy-button class="transfer-footer" slot="right-footer" size="mini">操作</jy-button>
    </jy-transfer>
  </div>
