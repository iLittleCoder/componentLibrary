...
<div class="box">
  <div class="top">
    <gj-tooltip class="item" effect="dark" content="悬浮出现的气泡" placement="top">
      <gj-button>上边</gj-button>
    </gj-tooltip>
  </div>
  <div class="left">
    <gj-tooltip class="item" effect="dark" content="悬浮出现的气泡" placement="left">
      <gj-button>左边</gj-button>
    </gj-tooltip>
  </div>

  <div class="right">
    <gj-tooltip class="item" effect="dark" content="悬浮出现的气泡" placement="right">
      <gj-button>右边</gj-button>
    </gj-tooltip>
  </div>
  <div class="bottom">
    <gj-tooltip class="item" effect="dark" content="悬浮出现的气泡" placement="bottom">
...
<gj-tooltip content="Bottom center" placement="bottom">
