...
<html lang="en">
  <head>
    ...
    <title>GildataDesign - The world's most popular Vue UI framework</title>
    <meta name="description" content="GildataDesign，一套为开发者、设计师和产品经理准备的基于 Vue 2.0 的桌面端组件库" />
  </head>
  <body>
    <script>
      if (!window.Promise) {
    ...
    <% if (process.env.NODE_ENV === 'production') { %>
      <script src="//lib.baomitu.com/vue/2.6.11/vue.min.js"></script>
