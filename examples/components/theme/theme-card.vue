...
.theme-card-item {
  ...
  &.is-upload {
    box-shadow: none;
    border: 1px dashed rgba(32,32,32,0.07);
  }
  &.is-upload:hover {
    box-shadow: none;
  }
  ...
  &:hover {
    box-shadow: 0 0 10px 0 rgba(32,32,32,0.45);
    .action {
      opacity: 1;
    }
  }
...
import dateUtil from 'GildataDesign/src/utils/date';
...
export default {
  ...
  computed: {
    ...
    mainColor() {
      return this.theme.global['$--color-primary'] || '#256DFF';
    },
    mainColor50() {
    ...
    borderBaseColor() {
      return this.theme.global['$--border-color-base'] || 'rgba(32,32,32,0.07)';
    },
    textSecondaryColor() {
